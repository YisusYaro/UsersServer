...
public class UserHealthDataUpdatedEvent extends Event {
  private static String EVENT_NAME = "userHealthDataUpdated";
  private String id;
  ...
  public UserHealthDataUpdatedEvent(
      String id,
      String identifier,
      String password,
      String name,
      ...
      String createdAt,
      String updatedAt) {
    super(id, UserHealthDataUpdatedEvent.EVENT_NAME);
    this.id = id;
